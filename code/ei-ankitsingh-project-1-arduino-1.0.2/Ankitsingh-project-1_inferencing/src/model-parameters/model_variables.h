...
const char* ei_classifier_inferencing_categories[] = { "banana_overripe", "banana_ripe", "cauliflower_fresh", "cauliflower_spoiled", "mango_ripe", "mango_unripe", "tomato_ripe", "tomato_unripe" };
...
const ei_impulse_t impulse_665846_0 = {
    .project_id = 665846,
    .project_owner = "Ankitsingh",
    .project_name = "Ankitsingh-project-1",
    .impulse_id = 1,
    ...
    .tflite_output_features_count = 1296,
...
ei_impulse_handle_t impulse_handle_665846_0 = ei_impulse_handle_t( &impulse_665846_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_665846_0;
